...
void Algortimos (int numeros, int quantidade); // Seleciona o algoritmo a ser usado
void Selecao(int numeros, int quantidade); // Seleciona a opcao do user
void PrintaVetor(int vetor[], int numeros); // printa um vetor aleatorio na tela
void TextoRecursao(); 
...
void mergesort(int vetor[], int aux[], int imin, int imax, int numeros);
void TextoQuickSort();
...
int main() {
    ...
    int numeros = 0, quantidade = 0;

    printf("Selecione a quantidade de numeros do vetor: "); scanf("%d", &numeros);
    printf("Selecione o maior numero possivel do vetor: "); scanf("%d", &quantidade);

    Selecao(numeros, quantidade);
...
void Selecao(int numeros, int quantidade) {
    ...
    switch (opcao)
    {
    case 1: Algortimos(numeros, quantidade); break;
    case 2: TextoRecursao(); printaSeparacao(); Selecao(numeros, quantidade); break;
    case 3: break;
    }

}

void Algortimos (int numeros, int quantidade) {

    int vetor[numeros], aux[numeros], min = 0, max = numeros - 1;

    srand(time(NULL));
  
    for (int o = 0; o < numeros; o++) {
      vetor[o] = rand() % quantidade;
    }
    ...
    switch (opcao)
    {
    case 1: printaSeparacao(); TextoBubblesort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); bubblesort(vetor, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade);  break;
    case 2: printaSeparacao(); TextoInsertionSort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); insertionsort(vetor, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade);  break;
    case 3: printaSeparacao(); TextoSelectionSort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); selectionsort(vetor, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade);  break;
    case 4: printaSeparacao(); TextoMergeSort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); mergesort(vetor, aux, min, max, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade);  break;
    case 5: printaSeparacao(); TextoQuickSort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); quicksort(vetor, min, max, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade);  break;
    case 6: printaSeparacao(); TextoHeapsort(); printf("\n\nvetor desordenado: "); PrintaVetor(vetor, numeros); printf("\n"); heap_sort(vetor, numeros); printf("\nvetor ordenado: "); PrintaVetor(vetor, numeros); printaSeparacao(); Algortimos(numeros, quantidade); break;
    case 7: printf("\n"); Selecao(numeros, quantidade); break;
    }
...
void PrintaVetor(int vetor[], int numeros) {
